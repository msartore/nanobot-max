<div align="center">
  ...
  <h1>nanobot-max: Ultra-Lightweight Personal AI Agent</h1>
  <p>
...
🐈 **nanobot-max** is an **ultra-lightweight** personal AI agent inspired by [OpenClaw](https://github.com/openclaw/openclaw).
